// Define the `pokemonApp` module
var pokemonApp = angular.module('pokemonApp', []);

// Define the `pokemonController` controller on the `pokemonApp` module
pokemonApp.controller('pokemonController', function pokemonController($scope) {
  $scope.pokemones = [
   {
    "id": 1,
    "num": "001",
